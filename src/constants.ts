...
export const INITIAL_GAME_PROMPT = "من یک ماجراجوی تازه‌کارم که در اتاقی سنگی، کم‌نور و پوشیده از خزه بیدار می‌شوم. هیچ خاطره‌ای از اینکه چگونه به اینجا رسیده‌ام ندارم. این اولین لحظه ماجراجویی من است. اولین صحنه را تولید کن. سلامتی من باید روی ۱۰۰ تنظیم شود.";
...
export const GAME_STATE_SCHEMA = {
    ...
    required: ["sceneDescription", "actions", "characterStatus", "health", "inventory", "gameOver", "gameWon", "storyRecap"]
};