    ...
    if (isLoading && !gameState) {
      return (
        <div className="flex flex-col items-center justify-center h-screen gap-4">
          <LoadingSpinner />
          <p className="text-xl font-title text-gray-400 animate-pulse">ماجراجویی شما در حال شکل‌گیری است...</p>
        </div>
      );
    }
    ...
    return (
      <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 bg-gray-900">
        <div className="text-center">
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-title text-white mb-4">افسانه بی‌پایان</h1>
